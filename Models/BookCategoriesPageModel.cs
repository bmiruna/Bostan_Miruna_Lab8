...
namespace Bostan_Miruna_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;

        public void PopulateAssignedCategoryData(Bostan_Miruna_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Bostan_Miruna_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
